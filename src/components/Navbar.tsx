      ...
      <div className='mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8'>
          ...
          <ul className='ml-12 inline-flex space-x-8'>
            {menuItems.map((item) => (
              <li key={item.name}>
                <a
                  href={item.href}
                  className='text-sm font-semibold hover:text-gray-900 dark:hover:text-gray-200'>
                  {item.name}
                </a>
              </li>
            ))}
        ...
        {isMenuOpen && (
          <div className='absolute inset-x-0 top-0 z-50 origin-top-right transform  p-2 transition lg:hidden'>
            <div className='divide-y-2 divide-gray-50 rounded-xl border dark:border-textDark bg-mainDark text-textDark shadow-lg ring-1 ring-black ring-opacity-5'>
              <div className='px-5 pb-6 pt-5'>
                <div className='flex items-center justify-between'>
                  <div className='inline-flex items-center space-x-2'>
                    ...
                    <span className='font-bold'>sameeksha</span>
                  </div>
                  <div className='-mr-2'>
                    <button
                      type='button'
